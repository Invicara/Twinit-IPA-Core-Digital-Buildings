...
#typeMap;
	...
	return new Promise(async (resolve, reject) => {
		try {
			...
			console.log(`bim_model, orch_run_id: ${this.params.orchRunId}`, bim_model)
	...
	return new Promise(async (resolve, reject) => {
		try {
			...
			for(const obj of bimBatch.objects) {
				if(objects.length === 0) {
					console.log(obj)
					console.log(obj, this.params.orchRunId)
					console.log(`Bimbatch: typeof package_id: ${typeof obj.id}, typeof type_id: ${typeof obj.type}, orch_run_id: ${this.params.orchRunId}`);
				...
				if(objects.length === 1) {
					...
					console.log(objects[0], this.params.orchRunId)
					console.log(`Objects-array: typeof package_id: ${typeof objects[0].package_id}, typeof type_id: ${typeof objects[0].type_id}, orch_run_id: ${this.params.orchRunId}`);
				}
			}
