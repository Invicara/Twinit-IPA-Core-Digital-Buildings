...
import {IafItemSvc, IafScriptEngine} from "@dtplatform/platform-api";
...
export const fetchAlertsBySystem = createAsyncThunk(
    ...
    async (args, thunkAPI) => {
        ...
        const allowedTypes = ['Asset','Space', 'Model Element', 'System'];
...
export const getSystemsSlice = (rootState) => {
    return rootState[VIEW_SYSTEMS_KEY];
}
