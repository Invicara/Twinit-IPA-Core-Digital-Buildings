...
import {
    ...
    TreeSelectMode,
    withEntitySearch, EntityActionsPanel, EntityListView, useSortEntities as useSortEntities
...
const EntityDetailBottomPanel = ({ /*props from HOC withEntityStore, HOC withEntitySearch, HOC withEntityConfig, HOC withEntityAvailableGroups*/
                                    availableDataGroups, entityType, config, getData, loadingDataGroups, selectedEntities, entitySingular,
                                    handler, onEntityChange, onActionSuccess, doEntityAction, context,
                                    isSearchDrawerOpen, isFilterDrawerOpen, isDataDrawerOpen,
                                    toggleSearchDrawer, toggleFilterDrawer, toggleDataDrawer, clearSearchAndFilters,
                                    entity, entityListSort, perEntityConfig, getEntityExtendedData, userConfig,
                                    /*props from parent component*/
                                    detailedEntity, selectedEntitiesBySearch, viewerMode, NavigatorSource}) => {
    ...
    let selectedEntity
    if (selectedDataGroup === 'System Properties') {
        selectedEntity = selectedEntitiesBySearch[0]
    }
     else if(detailedEntity.hasOwnProperty('entityInfo')) {
        selectedEntity = detailedEntity.entityInfo[0]
    } else {
