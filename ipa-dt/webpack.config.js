...
const CONFIG = {
  ...
  devServer: {
    ...
    historyApiFallback: {
      rewrites: [
        {from: /^\/digitaltwin\/logo_32px.png$/, to: `/${APP_ROOT}/logo_32px.png`},
        {from: /^\/digitaltwin\/helpers.js$/, to: `/${APP_ROOT}/helpers.js`},
        {from: /^\/digitaltwin\/config.js$/, to: `/${APP_ROOT}/config.js`},
        {from: /^\/digitaltwin\/version.js$/, to: `/${APP_ROOT}/version.js`},
        {from: /^\/digitaltwin\/fontawesome.css$/, to: `/${APP_ROOT}/fontawesome.css`},
        {from: /^\/digitaltwin\/webfonts$/, to: `/${APP_ROOT}/webfonts`},
        {from: /^\/digitaltwin\/fonts$/, to: `/${APP_ROOT}/fonts`},
        {from: /^\/digitaltwin\/icons$/, to: `/${APP_ROOT}/icons`},
        {from: /^\/digitaltwin/, to: `/${APP_ROOT}/`},
      ]
    }
  },
  mode: 'development',
