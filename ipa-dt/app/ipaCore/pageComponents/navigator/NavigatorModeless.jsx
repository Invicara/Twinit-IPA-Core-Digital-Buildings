...
const NavigatorModeless = ({isFetching, isSelectingEntity = false, searchTab, treeComponent, detailComponent, onModelReset, isolatedEntities}) => {
    ...
    useEffect(() => {
        if(!isFetching && selectedTabIndex === 0 && isolatedEntities.length>0) openTab(1)
    },[isFetching]);
