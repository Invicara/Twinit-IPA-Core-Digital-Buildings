...
const EntityDetailBottomPanelContent = ({config, getData, loadingDataGroups, detailedEntity, filteredDataGroups, selectedDataGroup: focusedGroup, onSelectedGroupChanged, viewerMode, NavigatorSource}) => {
    ...
    useEffect(() => {
        filteredDataGroups.forEach(dg => {
            ...
            else if (viewerMode === NavigatorSource?.SYSTEM && _.isEmpty(allSystems)) {
                removeSystemProps(filteredDataGroups)
            } else {
