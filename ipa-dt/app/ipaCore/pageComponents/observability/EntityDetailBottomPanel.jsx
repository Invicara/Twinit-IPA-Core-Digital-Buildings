...
import { withEntitySearch, withEntityAvailableGroups } from "@invicara/ipa-core/modules/IpaPageComponents";
...
const EntityDetailBottomPanel = ({/*props from HOC withEntityStore, HOC withEntitySearch, HOC withEntityConfig, HOC withEntityAvailableGroups*/
    ...
    const currentEntityExtendedDataConfig = useMemo(() => {
        ...
        if(defaultExtendedDataConfig){
            ...
            newCurrentConfig.data = {...newCurrentConfig.data,...Object.fromEntries(newCurrentConfigDataAsEntries)}
        }
...
export default withGenericPageContext(withEntitySearch(withEntityAvailableGroups(EntityDetailBottomPanel)))
