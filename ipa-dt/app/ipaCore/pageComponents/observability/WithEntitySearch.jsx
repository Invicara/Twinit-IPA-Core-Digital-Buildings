...
import {FileHelpers, ScriptHelper, ScriptCache} from '@invicara/ipa-core/modules/IpaUtils/index.js';
import _ from "lodash";
import {withEntityStore} from '@invicara/ipa-core/modules/IpaPageComponents/index.js';
...
const withEntitySearch = WrappedComponent => {
    const EntitySearchHOC =  class extends React.Component {
        ...
        setAvailableDataGroups = (entity, propertiesOnly) => {
            ...
            console.log("setting available groups");
