...
import './styles/pageComponents/ObservabilityView/ObservabilityView.scss'
...
import EntityEnabledIafViewer from '../ipaCore/components/EntityEnabledIafViewer'
import {initializeConnections} from "../ipaCore/redux/connections"
...
const onConfigLoad = async (store, userConfig, AppContext) => {
  ...
  if (userConfig.connectors && userConfig.connectors.length)
    store.dispatch(initializeConnections(userConfig.connectors))
}
